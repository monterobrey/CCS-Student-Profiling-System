...
import {
  DEAN_DASHBOARD_CONFIG,
  DEFAULT_STATS,
  DEFAULT_CHART_DATA,
  API_ENDPOINTS,
} from "../constants/DeanDashboard";
        ...
        const updatedStats = [
          {
            ...
            route: "/students",
            iconPath:
              '<path d="M9 8a3 3 0 100-6 3 3 0 000 6zM2 16a7 7 0 0114 0" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>',
          },
          {
            label: "Total Faculty",
          ...
          },
          {
            ...
            delta: "Target: 1.75",
            deltaClass:
              avgGwa > 0 && avgGwa <= 1.75 ? "positive" : "warning",
            fill:
              avgGwa > 0
                ? Math.max(0, Math.min(100, ((3 - avgGwa) / (3 - 1)) * 100)) +
                  "%"
                : "0%",
            iconBg: "#f5f3ff",
            iconColor: "#8b5cf6",
          ...
          },
          {
            ...
            fill:
              totalStudents > 0
                ? Math.min(100, (activeViolations / totalStudents) * 100) +
                  "%"
                : "0%",
            iconBg: "#fff1f2",
            iconColor: "#ef4444",
