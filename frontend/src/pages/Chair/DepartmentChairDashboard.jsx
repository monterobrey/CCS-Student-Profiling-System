...
const ChairDashboard = () => {
  ...
  const stats = useMemo(() => {
    const maxStudents = Math.max(chairStats.totalStudents, 1);
    ...
    return [
      ...
      {
        label: 'Total Faculty',
        value: chairStats.totalFaculty.toString(),
      ...
      },
      {
        ...
        value: chairStats.activeViolations.toString(),
      ...
      },
      {
        ...
        value: chairStats.pendingAwards.toString(),
