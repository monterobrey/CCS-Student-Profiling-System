...
export default function CourseManagement() {
  ...
  const fetchCourses = async () => {
    ...
    try {
      ...
      else showToast("error", res.message || "Failed to load courses.");
    } catch {
              ...
              <tbody>
                {filteredCourses.map((c) => (
                  <tr key={c.id}>
                    ...
                    <td>
                      {c.curriculum_programs && c.curriculum_programs.length > 0 ? (
                        <div style={{ display: "flex", flexWrap: "wrap", gap: "4px" }}>
                          {c.curriculum_programs.map((p) => (
                            <span key={p.id} className="program-badge-table">
                              {p.program_code}
                            </span>
                          ))}
                        </div>
                      ) : (
                        <span className="program-badge-table">
                    ...
                    <td>
                      <div className="units-breakdown">
                        ...
                        <span className="units-detail">
                          <span>Lec {c.lec_units}</span>
                          <span>·</span>
                          <span>Lab {c.lab_units}</span>
                        </span>
                      </div>
                    </td>
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    value={form.units}
                    readOnly
                    style={{ background: "#faf8f6", color: "#9a8070" }}
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => handleUnitChange("lec_units", e.target.value)}
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => handleUnitChange("lab_units", e.target.value)}
                  />
                </div>
