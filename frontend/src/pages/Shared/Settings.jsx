    ...
    <div className="page">
      <div className="page-header">
        <div>
          ...
          <p className="page-sub">Manage your account preferences and configurations.</p>
        </div>
      </div>
            ...
            <>
              <div className="settings-card">
                <div className="settings-card-header">
                  <svg viewBox="0 0 24 24" fill="none" className="settings-icon">
                    <path
                      d="M9 17H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v5M13 21l4-4m0 0l4 4m-4-4v6"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
        ...
        <div className="settings-side">
          ...
          <div className="settings-card notice-card">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              style={{ width: '32px', height: '32px', color: '#FF6B1A', marginBottom: '10px' }}
            >
              <path
                d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"
                stroke="currentColor"
            ...
            <p className="notice-desc">
              These settings are placeholders for features currently being built. They will be fully functional in a
              future update.
            </p>
          </div>
          ...
          <div className="settings-card danger-card">
            ...
            <div className="settings-card-body">
              <div className="setting-row">
                <div className="setting-info">
                  <p className="setting-label" style={{ color: '#ef4444' }}>
                    Deactivate Account
                  </p>
